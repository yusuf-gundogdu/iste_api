...
/**
 * Kategori tanımları — marka listeleri dahil tek gerçek kaynak.
 * `backfill-brands.ts` bu diziyi tekrar kullanır (tam reseed olmadan marka
 * upsert), bu yüzden dışa aktarılır.
 */
...
// Yalnızca doğrudan çalıştırıldığında seed et; `import`le (ör. backfill-brands)
// yan etki oluşturmaz.
